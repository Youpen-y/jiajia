...
/**
 * @brief jia_loadcheck() - check and record computation power of each processor in the system
 * 
 * @note Total computation power of all processors are always normalized to 1
 * 
 * Processor computation power = Old computation power / computation time since last jia_loadcheck() call
 */
void jia_loadcheck()
{
